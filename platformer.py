...
walk = [load_image('assets/images/characters/py_knight_rht_w2.png'),
        ...
        load_image('assets/images/characters/py_knight_rht_w5.png'),
        load_image('assets/images/characters/py_knight_rht_w6.png'),
        load_image('assets/images/characters/py_knight_rht_w7.png'),
...
tile_images = { "Grass_surface": load_image('assets/images/tiles/grass_block_surface.png'),
                "Grass_filler": load_image('assets/images/tiles/grass_block_filler.png'),
                "Grass_wall_lft": load_image('assets/images/tiles/grass_block_leftwall.png'),
                "Grass_corner_lft": load_image('assets/images/tiles/grass_block_leftcorner.png'),
                "Grass_wall_rht": load_image('assets/images/tiles/grass_block_rightwall.png'),
